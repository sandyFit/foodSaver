    ...
    return (
        <section id='how' className='w-full min-h-screen bg-purple-100'>
            <div className="w-full h-full grid grid-cols-2 px-16">
                <div className="w-full h-full flex flex-col justify-between col-span-1 col-start-1 
                    col-end-2 p-8 min-h-screen">
                ...
                <div className="col-span-1 col-start-2 col-end-3 flex items-center justify-center 
